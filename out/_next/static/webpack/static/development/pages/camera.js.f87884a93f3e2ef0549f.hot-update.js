...
function (_React$Component) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "topUp", function () {
      ...
      //   return;
      // }
      // if (dayjs().isBefore(this.state.lastTimeFaceShown.add(0.1, "second"))) {
      //   return;
      // }
...
//# sourceMappingURL=camera.js.f87884a93f3e2ef0549f.hot-update.js.map