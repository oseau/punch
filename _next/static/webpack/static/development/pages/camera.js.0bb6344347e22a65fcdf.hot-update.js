  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "topUp", function () {
      ...
      if (lodash_isNull__WEBPACK_IMPORTED_MODULE_4___default()(_this.state.lastTimeFaceShown) || dayjs__WEBPACK_IMPORTED_MODULE_3___default()().isAfter(_this.state.lastTimeFaceShown.add(10, "second"))) {
        ...
        _this.setState({
          lastTimeFaceShown: dayjs__WEBPACK_IMPORTED_MODULE_3___default()().subtract(10, "second")
        });
      ...
      console.log("now", dayjs__WEBPACK_IMPORTED_MODULE_3___default()());

      if (dayjs__WEBPACK_IMPORTED_MODULE_3___default()().isBefore(_this.state.lastTimeFaceShown.add(0.5, "second"))) {
        console.log(2);
        return;
      }

      console.log(3); // if (this.state.blocking || !this.props.isActive()) {
      //   return;
      // }
    ...
    _this.topUpDebounced = lodash_debounce__WEBPACK_IMPORTED_MODULE_5___default()(_this.topUp, 500);
    return _this;
  }
...
//# sourceMappingURL=camera.js.0bb6344347e22a65fcdf.hot-update.js.map